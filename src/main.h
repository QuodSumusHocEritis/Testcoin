...
static const int64 DUST_SOFT_LIMIT = 100000; // 0.001 TST
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = 1000;   // 0.00001 TST mininput
/** No amount larger than this (in satoshi) is valid */
static const int64 MAX_MONEY = 201250 * COIN;
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 2880 / 250; //Number of blocks found per difficulty period (48 hours * 60 blocks per hour)
    }
